...
public class Question_17_6 {
	...
	public static Tuple2<Integer, Integer> findUnsortedSequence(int[] array) {
		// find left subsequence
		int end_left = findEndOfLeftSubsequence(array);	
		
		if (end_left >= array.length - 1) {
			//System.out.println("The array is already sorted.");
			return new Tuple2<Integer, Integer>(-1, -1); // Already sorted
		}
		...
		return new Tuple2<Integer, Integer>(left_index, right_index + 1);
	}
