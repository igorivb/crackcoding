...
public class BTree implements Dictionary
{
   ...
   public static void main(String[] args) {
	   ...
	   tree.insert(new StringElement("5"));
	   tree.insert(new StringElement("7"));
	   tree.insert(new StringElement("10"));
	   tree.insert(new StringElement("12"));
	   tree.insert(new StringElement("16"));
	   tree.insert(new StringElement("20"));
